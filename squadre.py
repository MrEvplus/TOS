...
def show_goal_patterns(df, team1, team2, country, stagione):
    df_team1_home = df[(df["Home"] == team1) & (df["country"] == country) & (df["Stagione"] == stagione)]
    df_team2_away = df[(df["Away"] == team2) & (df["country"] == country) & (df["Stagione"] == stagione)]
...
# --------------------------------------------------------
# QUI devi incollare la compute_goal_patterns che ti ho mandato nel messaggio precedente!
